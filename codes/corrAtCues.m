function [corrIMean,corrNIMean,corrIPeak,corrNIPeak] = corrAtCues(useIdx,useFolders,allDistancesIGroup,allDistancesNIGroup,cueCellDataThresh,NCell,NShuffle)
