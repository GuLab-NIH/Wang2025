function [corrIMean,corrNIMean,corrIPeak,corrNIPeak] = corrAtCuesNoShuffleAllIdxFov(useIdx,useFolders,allDistancesIGroup,allDistancesNIGroup,cueCellDataThresh)
