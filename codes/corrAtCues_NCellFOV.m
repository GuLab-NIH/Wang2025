function [randomCells,corrIMean,corrNIMean,corrIPeak,corrNIPeak] = corrAtCues_NCellFOV(useIdx,useFolders,allDistancesIGroup,allDistancesNIGroup,cueCellDataThresh,NCell)
