function [corrIMean,corrNIMean,corrIPeak,corrNIPeak] = corrAtCuesNoShuffle_inputBin(useIdx,useFolders,allDistancesIGroupWithCueBin,allDistancesNIGroupWithCueBin,expandBin)
