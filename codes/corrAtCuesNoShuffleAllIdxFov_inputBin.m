function [corrIMean,corrNIMean,corrIPeak,corrNIPeak] = corrAtCuesNoShuffleAllIdxFov_inputBin(useIdx,useFolders,allDistancesIGroupWithCueBin,allDistancesNIGroupWithCueBin,expandBin)
...
for m=1:length(allDistancesIGroupWithCueBin);%every distance 
        ...
        cueBin1=[cue1BinCenter-expandBin+1:cue1BinCenter+expandBin];
        cue2BinCenter=ceil(sum(allDistancesIGroupWithCueBin{m}(i,[7 8]))/2)-1;
        cueBin2=[cue2BinCenter-expandBin+1:cue2BinCenter+expandBin];
