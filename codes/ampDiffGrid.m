function [ampDiffIMean,ampDiffNIMean,ampDiffIPeak,ampDiffNIPeak] = ampDiffGrid(useIdx,useFolders,allDistancesIGroup,allDistancesNIGroup)

%this is similar to ampDiff, but for grid cells, so does not
