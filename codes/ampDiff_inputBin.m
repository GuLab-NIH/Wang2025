function [ampDiffIMean,ampDiffNIMean,ampDiffIPeak,ampDiffNIPeak] = ampDiff_inputBin(useIdx,useFolders,allDistancesIGroupWithCueBin,allDistancesNIGroupWithCueBin,expandBin)
